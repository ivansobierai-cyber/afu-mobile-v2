...
/**
 * Tela de Cadastro — Interface moderna para criar conta
 *
 * Oferece:
 * - Campos: nome, e-mail, telefone, senha
 * - Seleção de perfil (produtor/técnico/administrador)
 * - Aceitar termos
 * - Validação completa
 */
export default function CadastroScreen() {
  ...
  const handleSignUp = async () => {
    ...
    if (result.success && result.user) {
      console.log('[CadastroScreen] Cadastro bem-sucedido:', result.user);
      Alert.alert('Sucesso', 'Conta criada com sucesso! Redirecionando para o dashboard...');
      router.replace('/(tabs)');
    } else {
      console.error('[CadastroScreen] Erro ao criar conta:', result.error);
      Alert.alert(
        'Erro ao criar conta',
